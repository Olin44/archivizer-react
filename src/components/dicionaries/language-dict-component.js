...
export default class EnhancedTable extends Component {
    ...
    fetchDataAboutLanguagesFromApi(page, rowsPerPage){
    ...
    componentDidMount(){
        ...
        this.fetchDataAboutLanguagesFromApi(this.state.page, this.state.rowsPerPage);
    }
    ...
    handleChangePage = (event, newPage) => {
        console.log(newPage);
        this.fetchDataAboutLanguagesFromApi(newPage, this.state.rowsPerPage);
    ...
    handleChangeRowsPerPage = (event) => {
        ...
        this.fetchDataAboutLanguagesFromApi(0, newRowsPerPage);
